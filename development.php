...
<html lang="en">
  <head>
    ...
    <title>Ultracafe Cyber Device Booking System || Development PCs</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2 style="font-family: Roboto Condensed">Development PCs</h2>
                    </div>
                </div>
            </div>
        </div>
...
// Formula for pagination
        ...
        $ret1=mysqli_query($con,"select COUNT(*) from  tbldevice where Type='Development'");
$total_rows = mysqli_fetch_array($ret1)[0];
$total_pg = ceil($total_rows / $no_of_records_per_page);                                                   
 $query=mysqli_query($con,"select * from tbldevice where Type='Development' LIMIT $offset, $no_of_records_per_page");
