...
<head>
    ...
    <title>Cybercafe Devices Booking | Completed Booking for Devices</title>
...
<?php include_once('includes/header.php');?>
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Completed Booking for Devices</h4>
                    <div class="container-fluid">
                        <div class="row">
                            <table class="table table-bordered">
                                ...
                                <?php
$ret=mysqli_query($con,"select tblbooking.updated_at, tblbooking.updated_by, tblbooking.ID as bid,tblbooking.UserID,tblbooking.DeviceID,tblbooking.BookingNumber,tblbooking.DateofBooking,tblbooking.Status,tbluser.FirstName,tbluser.LastName,tbluser.Email,tbluser.MobileNumber,tbldevice.DeviceName from  tblbooking join  tbluser on tbluser.ID=tblbooking.UserID join tbldevice on tbldevice.ID=tblbooking.DeviceID where tblbooking.Status='Completed'");
$cnt=1;
