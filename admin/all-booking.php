...
<head>
    ...
    <title>Cybercafe Devices || All Previous Booking </title>
...
<?php include_once('includes/header.php');?>
            ...
            <section class="tables-section">
                ...
                <!-- table output of all booking -->
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">All Booking for Devices</h4>
                    <div class="container-fluid">
                        <div class="row">
                            <table class="table table-bordered">
                                ...
                                <?php
$ret=mysqli_query($con,"select tblbooking.updated_at, tblbooking.updated_by, tblbooking.ID as bid,tblbooking.UserID,tblbooking.DeviceID,tblbooking.BookingNumber, tblbooking.DateofBooking,tblbooking.Status,tbluser.FirstName,tbluser.LastName,tbluser.Email,tbluser.MobileNumber,tbldevice.DeviceName from  tblbooking join  tbluser on tbluser.ID=tblbooking.UserID join tbldevice on tbldevice.ID=tblbooking.DeviceID");
$cnt=1;
...
?>
                  ...
                  <?php } ?>     
                    ...
                    <!-- del booking -->
                      <a class="btn btn-sm btn-primary" href="all-booking.php?did=<?php echo $row['bid'];?>&pid=<?php echo $row['DeviceID'] ?>&status=$row['Status']"  onclick="return confirm('Do you really want to Delete ?');"> <i class="fa fa-times" aria-hidden="true"></i> Delete</a>

       
                <?php 
                    $cnt=$cnt+1; //count the booking number and input in seq at line 124
                }?>                              
