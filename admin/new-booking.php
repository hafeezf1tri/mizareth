  ...
  header('location:logout.php');
    ...
    if(isset($_GET['did']))
    {
        ...
        if($query1){
            ...
            echo "<script type='text/javascript'> document.location = 'new-booking.php'; </script>";
...
<head>
    ...
    <title>Cybercafe Devices Booking| New Booking for Devices</title>
...
<?php include_once('includes/header.php');?>
            ...
            <section class="tables-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">New Booking for Devices</h4>
                    <div class="container-fluid">
                        <div class="row">
                            <table class="table table-bordered">
                                ...
                                <?php
$ret=mysqli_query($con,"select tblbooking.updated_at, tblbooking.updated_by, tblbooking.ID as bid,tblbooking.UserID,tblbooking.DeviceID,tblbooking.BookingNumber, tblbooking.DateofBooking,tblbooking.Status,tbluser.FirstName,tbluser.LastName,tbluser.Email,tbluser.MobileNumber,tbldevice.DeviceName from  tblbooking join  tbluser on tbluser.ID=tblbooking.UserID join tbldevice on tbldevice.ID=tblbooking.DeviceID where tblbooking.Status is null");
$cnt=1;
...
<?php } else { ?>                  <td><?php  echo htmlentities($row['Status']);?>
                  ...
                  <td><a class="btn btn-sm btn-primary" href="view-booking.php?viewid=<?php echo $row['bid'];?>"><i class="fa fa-eye" aria-hidden="true"></i> View</a>
                    <a class="btn btn-sm btn-primary" href="new-booking.php?did=<?php echo $row['bid'];?>&pid=<?php echo $row['DeviceID'] ?>"  onclick="return confirm('Do you really want to Delete ?');"><i class="fa fa-times" aria-hidden="true"></i> Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>                              
