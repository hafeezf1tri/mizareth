...
$query=mysqli_query($con,"delete from tbluser where ID='$rid'");
if($query){

echo "<script>alert('User was deleted successfully.');</script>";
echo "<script type='text/javascript'> document.location = 'register-users.php'; </script>";
} else {
...
?>
            ...
            <td><?php echo $cnt;?></td>
                  ...
                  <td><a class="btn btn-sm btn-primary" href="register-users.php?delid=<?php echo $row['ID'];?>"  onclick="return confirm('Do you really want to Delete ?');"> <i class="fa fa-times" aria-hidden="true"></i> Delete</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?> 
